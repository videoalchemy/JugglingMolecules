...
class Particle {
  ...
  public void update() {
    ...
    if(acceleration.mag() < accLimiter)
    {
      ...
      //tint (100,acceleration.mag() * 255);//4 May:: turnd this off
      tint (50,acceleration.mag() * 255);//4 May:: turnd this off
      
      clr = color (g+particleManager.greyscaleOffset,0,g+particleManager.greyscaleOffset); //4 May::turned this off
